...
(add-to-list 'load-path "~/git/dotfiles/emacs.d/site-lisp/color-theme/")
(require 'color-theme)
...
;; 模板
;;------------------------------------------------------------------
(defun inst_tmpl_annotate()
  "insert a template of annotate" 
  (interactive)
  (insert ";;------------------------------------------------------------------\n;; \n;;------------------------------------------------------------------")
  )

(defun inst_jekyll_head()
  "insert a default head"
  (interactive)
  (insert "---\nlayout: post\ntitle: \ncategory: \ncomments: false\n---\n")
  )
